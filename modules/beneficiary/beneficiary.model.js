...
const schema = {
  ...
  address: {
    type: String,
    joi: Joi.string().optional().description('Beneficiary permanent address')
  },
  address_temporary: {
    type: String,
    joi: Joi.string().optional().description('Beneficiary temporary address')
  },
  govt_id: {
    type: String,
    joi: Joi.string().optional().description('Beneficiary government issued ID')
  },
  photo: {type: String, joi: Joi.string().optional().description('Beneficiary photo url')},
  issued_packages: Array,
  govt_id_image: {
    type: String,
  ...
  bank_account: {
    ...
    account_number: {
      type: String,
      joi: Joi.string().optional().description('Beneficiary bank account number')
    },
    account_name: {
      type: String,
      joi: Joi.string().optional().description('Beneficiary bank account name')
    }
  },
  extras: {type: Object},
