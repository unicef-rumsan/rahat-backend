...
const schema = {
  ...
  pan_number: {
    type: String,
    joi: Joi.string().allow('').optional().description('Vendor PAN number')
  },
  bank_name: {type: String, joi: Joi.string().allow('').optional().description('Bank name')},
  bank_branch: {
    type: String,
    joi: Joi.string().allow('').optional().description('Bank branch name')
  },
  bank_account: {
    type: String,
    joi: Joi.string().allow('').optional().description('Bank account number')
  },
